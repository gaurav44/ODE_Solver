...
The user needs to download googletest [https://github.com/google/googletest](url) and eigen-3.4-rc1 [https://eigen.tuxfamily.org/index.php?title=Main_Page](url) libraries and place them in the folder `lib`. The user should have `Cmake` and `make` installed to build /compile, and numpy and matplotlib to plot the solution.<br />
